...
/*  Route::get('/posts',[PostController::class,'showUsers']);
    ...
    Route::get('/posts/delete/{id}',[PostController::class,'deleteUsers']);
    Route::get('/posts/update/{id}',[PostController::class,'']);
*/
//------------------------------------------------------------------------
...
//    Route::get('posts/delete/{id}','deleteUsers');
 //   Route::get('posts/update/{id}','updateUsers');
...
/*
      *               // حذف دالة من دوال الكونترولار اثناء الاستعلام (resource)
    //ولاعطاء الصلاحية لدوال معينة نستخدم(only) بدلا من (except)
    Route::resource('users',\App\Http\Controllers\UserController::class)->except([ 'create']);
*/

//------------------------------------------------------------------------------

//create invoke controller     php artisan make:controller UserProfileController -i
 //       Route::get('user_profile',UserProfileController::class);

//--------------------------------------------------------------------------------

//هو عبارة عن عدم السماح للمستخدم الذي لم يسجل الدخول من عرض الصفحة
//construct in controller منحسن نعملو للكونترولر اللي من نوع (Resource)
